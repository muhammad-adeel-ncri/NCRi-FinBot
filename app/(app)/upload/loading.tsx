  ...
  return (
    <div className="page-content">
      <div className="page-header" style={{ textAlign: 'center' }}>
        <div className="skeleton" style={{ height: 24, width: 200, borderRadius: 6, margin: '0 auto' }} />
        <div className="skeleton" style={{ height: 14, width: 340, borderRadius: 4, marginTop: 10, margin: '10px auto 0' }} />
      </div>
